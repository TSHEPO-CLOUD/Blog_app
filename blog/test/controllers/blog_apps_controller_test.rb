...
class BlogAppsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_app" do
    assert_difference('BlogApp.count') do
      post blog_apps_url, params: { blog_app: { body: @blog_app.body, topic: @blog_app.topic } }
    end
  ...
  test "should update blog_app" do
    patch blog_app_url(@blog_app), params: { blog_app: { body: @blog_app.body, topic: @blog_app.topic } }
